...
<html>
	...
	<body>
		<a href="#search-institucion" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="search-institucion" class="content scaffold-list" role="main">
						...
						<tbody>
							<tr class="prop">
								...
								<td valign="top" class="name">
									<label for="nombre" >${message(code: 'institucion.nombre.label', default: 'Nombre')}</label>
									<g:textField name="nombre" />
								</td>
							
								<td valign="top" class="name">
									<label for="privada" >${message(code: 'institucion.privada.label', default: 'Privada')}</label>
									<g:textField name="privada" />
								</td>
							
								<td valign="top" class="name">
									<label for="dateCreated" >${message(code: 'institucion.dateCreated.label', default: 'Date Created')}</label>
